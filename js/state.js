...
export const empleadosEsmeraldaDB = [];  // catálogo: [{id,nombre,genero,costoDia}, ...] (tabla: empleados_esmeralda) — tarifa fija diaria
export const actividadEmpleadosDB = {};  // { codigo_actividad: [{id,nombre,genero,costoDia}, ...] } — solo para trazabilidad (quién participó), ya no se usa para costear
